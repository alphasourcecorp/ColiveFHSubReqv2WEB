...
export const environment = {
  ...
  getScheduleUrl:"https://colivefoodyhivesubscriptionrequest-v2.azurewebsites.net/api/Scheduling/GetSchedulesByCompanyID",
  ScheduleListUrl:"https://colivefoodyhivesubscriptionrequest-v2.azurewebsites.net/api/Scheduling/GetSchedulesByID",
  DeleteScheduleUrl:"https://colivefoodyhivesubscriptionrequest-v2.azurewebsites.net/api/Scheduling/DeteleSchedule",
